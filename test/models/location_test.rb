...
class LocationTest < ActiveSupport::TestCase
  ...
  context "Within context" do
    ...
    should "allow locations without past camps to be destroyed" do
      assert @north.camps.past.empty?
      assert @north.destroy
    end
    
    should "not allow any locations with past camps to be destroyed" do
      create_curriculums
      create_camps
      @camp1.update(start_date: 5.day.ago)
      @camp1.update(end_date: 1.day.ago)
